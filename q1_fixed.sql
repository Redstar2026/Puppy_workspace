...
comparacion AS (
  SELECT
    ...
    CASE
      ...
      WHEN sw7.PRECIO_COMP_LOW IS NULL AND sw8.PRECIO_COMP_LOW IS NOT NULL THEN 'Nuevo'
      WHEN sw8.PRECIO_COMP_LOW IS NULL                               THEN 'Sin precio'
      WHEN sw8.PRECIO_COMP_LOW < sw7.PRECIO_COMP_LOW                THEN 'Bajo'
      WHEN sw8.PRECIO_COMP_LOW > sw7.PRECIO_COMP_LOW                THEN 'Subio'
      ELSE 'Mantiene'
    END AS segmento,
    COUNT(*) AS cantidad
  FROM sw8
